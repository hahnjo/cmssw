#ifndef FWIO_RNTupleTempOutput_RootOutputFileMPI_h
#define FWIO_RNTupleTempOutput_RootOutputFileMPI_h

//////////////////////////////////////////////////////////////////////
//
// Class RootOutputFileMPI
//
...
#include "FWIO/RNTupleTempOutput/src/RootOutputRNTupleMPI.h"
...
namespace edm::rntuple_temp {
  class RootOutputFileMPI {
  public:
    using OutputItem = RNTupleTempOutputModuleMPI::OutputItem;
    using OutputItemList = RNTupleTempOutputModuleMPI::OutputItemList;
    explicit RootOutputFileMPI(RNTupleTempOutputModuleMPI* om,
  ...
  private:
    ...
    edm::propagate_const<RNTupleTempOutputModuleMPI*> om_;
    ...
    RootOutputRNTupleMPI eventRNTuple_;
    RootOutputRNTupleMPI lumiRNTuple_;
    RootOutputRNTupleMPI runRNTuple_;
    std::vector<edm::propagate_const<std::unique_ptr<RootOutputRNTupleMPI>>> processBlockRNTuples_;
    std::vector<edm::propagate_const<RootOutputRNTupleMPI*>> treePointers_;
