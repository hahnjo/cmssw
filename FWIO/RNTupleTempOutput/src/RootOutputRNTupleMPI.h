#ifndef FWIO_RNTupleTempOutput_RootOutputRNTupleMPI_h
#define FWIO_RNTupleTempOutput_RootOutputRNTupleMPI_h

/*----------------------------------------------------------------------

RootOutputRNTupleMPI.h // used by ROOT output modules
...
namespace edm {
  ...
  public:
    ...
    RootOutputRNTupleMPI(std::shared_ptr<TFile> filePtr,
                      std::string const& fileName,
                      BranchType const& branchType,
                      std::string const& processName = std::string());

    ~RootOutputRNTupleMPI() {}

    RootOutputRNTupleMPI(RootOutputRNTupleMPI const&) = delete;             // Disallow copying and moving
    RootOutputRNTupleMPI& operator=(RootOutputRNTupleMPI const&) = delete;  // Disallow copying and moving
