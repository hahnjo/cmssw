#ifndef FWIO_RNTupleTempOutput_RNTupleTempOutputModuleMPI_h
#define FWIO_RNTupleTempOutput_RNTupleTempOutputModuleMPI_h

//////////////////////////////////////////////////////////////////////
//
// Class RNTupleTempOutputModuleMPI. Output module to POOL file
//
...
namespace edm::rntuple_temp {
  ...
  class RNTupleTempOutputModuleMPI : public one::OutputModule<WatchInputFiles> {
  public:
    ...
    explicit RNTupleTempOutputModuleMPI(ParameterSet const& ps);
    ~RNTupleTempOutputModuleMPI() override;
    RNTupleTempOutputModuleMPI(RNTupleTempOutputModuleMPI const&) = delete;             // Disallow copying and moving
    RNTupleTempOutputModuleMPI& operator=(RNTupleTempOutputModuleMPI const&) = delete;  // Disallow copying and moving
  ...
  private:
    ...
    bool mergeJob_;
    edm::propagate_const<std::unique_ptr<RootOutputFileMPI>> rootOutputFile_;
