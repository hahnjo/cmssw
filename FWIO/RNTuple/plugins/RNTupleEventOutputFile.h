#if !defined(FWIO_RNTuple_RNTupleEventOutputFile_h)
#define FWIO_RNTuple_RNTupleEventOutputFile_h
...
namespace edm {
  ...
  public:
    ...
    explicit RNTupleEventOutputFile(std::string const& iFileName,
                               FileBlock const& iFileBlock,
                               SelectedProductsForBranchType const& iSelected,
                               Config const&,
                               bool anyProductProduced);
    ~RNTupleEventOutputFile();
