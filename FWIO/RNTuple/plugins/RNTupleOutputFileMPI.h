#if !defined(FWIO_RNTuple_RNTupleOutputFileMPI_h)
#define FWIO_RNTuple_RNTupleOutputFileMPI_h
...
namespace edm {
  ...
  public:
    ...
    explicit RNTupleOutputFileMPI(std::string const& iFileName,
                               FileBlock const& iFileBlock,
                               SelectedProductsForBranchType const& iSelected,
                               Config const&,
                               bool anyProductProduced);
    ~RNTupleOutputFileMPI();
