#if !defined(FWIO_RNTuple_RNTupleMPIOutputFile_h)
#define FWIO_RNTuple_RNTupleMPIOutputFile_h
...
namespace edm {
  ...
  public:
    ...
    explicit RNTupleMPIOutputFile(std::string const& iFileName,
                               FileBlock const& iFileBlock,
                               SelectedProductsForBranchType const& iSelected,
                               Config const&,
                               bool anyProductProduced);
    ~RNTupleMPIOutputFile();
