...
namespace edm {
  RNTupleEventOutputFile::RNTupleEventOutputFile(std::string const& iFileName,
...
explicitly pass the correct variable to `SetColumnRepresentatives`).
  ...
  void RNTupleEventOutputFile::setupDataProducts(SelectedProducts const& iProducts,
  ...
  std::vector<RNTupleEventOutputFile::Product> RNTupleEventOutputFile::associateDataProducts(SelectedProducts const& iProducts,
  ...
  void RNTupleEventOutputFile::setupEvents(SelectedProducts const& iProducts,
    ...
    std::string kBranchListName = "BranchListIndexes";
    {
      ...
      events_ = ROOT::Experimental::RNTupleWriter::Recreate(std::move(model), "Events", fileName_, writeOptions);
    }
  ...
  void RNTupleEventOutputFile::openFile(FileBlock const& fb) {
  ...
  std::vector<std::unique_ptr<WrapperBase>> RNTupleEventOutputFile::writeDataProducts(std::vector<Product> const& iProducts,
  ...
  std::vector<StoredProductProvenance> RNTupleEventOutputFile::writeDataProductProvenance(
  ...
  bool RNTupleEventOutputFile::insertProductProvenance(ProductProvenance const& iProv,
    ...
    if (itFound == oToInsert.end()) {
      ...
      if (toStore.parentageIDIndex_ >= parentageIDs_.size()) {
        throw edm::Exception(errors::LogicError)
            << "RNTupleEventOutputFile::insertProductProvenance\n"
  ...
  void RNTupleEventOutputFile::insertAncestorsProvenance(ProductProvenance const& iProv,
  ...
  void RNTupleEventOutputFile::write(EventForOutput const& e) {
    {
  ...
  void RNTupleEventOutputFile::writeLuminosityBlock(LuminosityBlockForOutput const& iLumi) {
  ...
  void RNTupleEventOutputFile::writeRun(RunForOutput const& iRun) {
