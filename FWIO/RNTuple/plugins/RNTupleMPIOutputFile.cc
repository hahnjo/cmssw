#include "RNTupleMPIOutputFile.h"
...
namespace edm {
  RNTupleMPIOutputFile::RNTupleMPIOutputFile(std::string const& iFileName,
...
explicitly pass the correct variable to `SetColumnRepresentatives`).
  ...
  void RNTupleMPIOutputFile::setupDataProducts(SelectedProducts const& iProducts,
  ...
  std::vector<RNTupleMPIOutputFile::Product> RNTupleMPIOutputFile::associateDataProducts(SelectedProducts const& iProducts,
  ...
  std::unique_ptr<RNTupleModel> RNTupleMPIOutputFile::setupCommonModels(SelectedProducts const& iProducts,
  ...
  void RNTupleMPIOutputFile::setupEvents(SelectedProducts const& iProducts,
                                      Config const& iConfig,
                                      bool anyProductProduced) {
    ...
    std::string kBranchListName = "BranchListIndexes";
    {
      ...
      events_ = RNTupleWriterMPI::Recreate(std::move(config), kRoot, MPI_COMM_WORLD);
    }
  ...
  void RNTupleMPIOutputFile::openFile(FileBlock const& fb) {
  ...
  std::vector<std::unique_ptr<WrapperBase>> RNTupleMPIOutputFile::writeDataProducts(std::vector<Product> const& iProducts,
  ...
  std::vector<StoredProductProvenance> RNTupleMPIOutputFile::writeDataProductProvenance(
  ...
  bool RNTupleMPIOutputFile::insertProductProvenance(ProductProvenance const& iProv,
    ...
    if (itFound == oToInsert.end()) {
      ...
      if (toStore.parentageIDIndex_ >= parentageIDs_.size()) {
        throw edm::Exception(errors::LogicError)
            << "RNTupleMPIOutputFile::insertProductProvenance\n"
  ...
  void RNTupleMPIOutputFile::insertAncestorsProvenance(ProductProvenance const& iProv,
  ...
  void RNTupleMPIOutputFile::write(EventForOutput const& e) {
    {
  ...
  void RNTupleMPIOutputFile::writeLuminosityBlock(LuminosityBlockForOutput const& iLumi) {
  ...
  void RNTupleMPIOutputFile::writeRun(RunForOutput const& iRun) {
